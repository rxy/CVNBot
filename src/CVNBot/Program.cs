...
namespace CVNBot
{
    ...
    class Program
    {
            ...
            if (cmdMatch.Success)
            {
                ...
                switch (command)
                {
                    ...
                    case "status":
                        ...
                        SendMessageF(/*SendType.Message*/SendType.Notice, e.Data.Channel, "Last message was received on RCReader "
                            + ago.TotalSeconds + " seconds ago", false, false);
                        break;
                    case "help":
                        SendMessageF(/*SendType.Message*/SendType.Notice, e.Data.Channel, (String)msgs["20005"], false, true);
                        break;
                    case "version":
                    case "settings":
                    case "config":
                    ...
                    case "msgs":
                        ...
                        if (!hasPrivileges('@', ref e))
                            return;
                        readMessages((string)mainConfig["messages"]);
                        SendMessageF(/*SendType.Message*/SendType.Notice, e.Data.Channel, "Re-read messages", false, false);
                        break;
                    case "reload":
                        ...
                        try
                        {
                            ...
                            SendMessageF(/*SendType.Message*/SendType.Notice, e.Data.Channel, "Reloaded project " + cmdParams[0], false, false);
                        }
                        catch (Exception ex)
                        {
                            SendMessageF(/*SendType.Message*/SendType.Notice, e.Data.Channel, "Unable to reload: " + ex.Message, false, true);
                    ...
                    case "load":
                        ...
                        try
                        {
                            ...
                            SendMessageF(/*SendType.Message*/SendType.Notice, e.Data.Channel, "Loaded new project " + cmdParams[0], false, true);
                            //Automatically get admins and bots:
                            Thread.Sleep(200);
                            SendMessageF(/*SendType.Message*/SendType.Notice, e.Data.Channel, listman.configGetAdmins(cmdParams[0]), false, false);
                            Thread.Sleep(500);
                            SendMessageF(/*SendType.Message*/SendType.Notice, e.Data.Channel, listman.configGetBots(cmdParams[0]), false, false);
                        }
                        catch (Exception ex)
                        {
                            SendMessageF(/*SendType.Message*/SendType.Notice, e.Data.Channel, "Unable to add project: " + ex.Message, false, true);
                        ...
                        try
                        {
                            if (cmdParams[0].Length > 0)
                            {
                                ...
                                else
                                {
                                    ...
                                    SendMessageF(/*SendType.Message*/SendType.Notice, e.Data.Channel, "Bleeped. Please wait for a reply.", false, true);
                                }
                            }
                        } catch (Exception ex)
                        {
                            SendMessageF(/*SendType.Message*/SendType.Notice, e.Data.Channel, "Unable to bleep: " + ex.Message, false, true);
                        }
                        break;
                    case "count":
                        if (!hasPrivileges('+', ref e))
                    ...
                    case "drop":
                        ...
                        try
                        {
                            ...
                            SendMessageF(/*SendType.Message*/SendType.Notice, e.Data.Channel, "Deleted project " + cmdParams[0], false, true);
                        }
                        catch (Exception ex)
                        {
                            SendMessageF(/*SendType.Message*/SendType.Notice, e.Data.Channel, "Unable to delete project: " + ex.Message, false, true);
                    ...
                    case "list":
                        ...
                        SendMessageFMulti(/*SendType.Message*/SendType.Notice, e.Data.Channel, result, false, true);
                        break;
                    case "batchgetusers":
                        if (!hasPrivileges('@', ref e))
                            return;
                        ...
                        break;
                    case "bl":
                        SendMessageF(/*SendType.Message*/SendType.Notice, e.Data.Channel,
                    ...
                    case "getadmins":
                        if (!hasPrivileges('@', ref e))
                            return;
                            SendMessageF(/*SendType.Message*/SendType.Notice, e.Data.Channel, listman.configGetAdmins(extraParams), false, true);
                            break;
                     case "getbots":
                        if (!hasPrivileges('@', ref e))
                            return;
                            SendMessageF(/*SendType.Message*/SendType.Notice, e.Data.Channel, listman.configGetBots(extraParams), false, true);
                            break;

                    case "intel":
                        string intelResult = listman.GlobalIntel(extraParams);
                        SendMessageFMulti(/*SendType.Message*/SendType.Notice, e.Data.Channel, intelResult, false, true);
                        break;
                    case "purge":
                        if (!hasPrivileges('@', ref e))
                            return;
                        SendMessageF(/*SendType.Message*/SendType.Notice, e.Data.Channel, listman.purgeWikiData(extraParams), false, true);
                        break;
                    case "batchreload":
                        if (!hasPrivileges('@', ref e))
                            return;
        ...
        public static void ReactToRCEvent(RCEvent r)
        {
            ...
            SendMessageFMulti(/*SendType.Message*/SendType.Notice, FeedChannel, message, true, false);
